...
public class SubmitCreateCommunityBadgeApplicationEndpoint(
    IMediator mediator,
    ...
    : Endpoint<SubmitCommunityLeaderApplicationRequest, StandardResponse>
{
    ...
    {
        Post("/communities/create-community-badge/submit");
    ...
    public override async Task HandleAsync(SubmitCommunityLeaderApplicationRequest req, CancellationToken ct)
    {
        ...
        var reason = BuildReason("D01.2 - Create Community Badge", req);
        var command = new SubmitTagVerificationCommand(
            userId.Value,
            CommunityVerificationTags.ApplyForCreateACommunityId,
            reason,
            DocumentType.LetterOfRecommendation,
