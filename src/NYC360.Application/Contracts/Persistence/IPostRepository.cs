...
public interface IPostRepository
{
    ...
    Task<PostDetailsDto?> GetPostWithDetailsDtoByIdAsync(int id, int? userId, CancellationToken ct);
    Task<(List<PostDto>, int)> GetAllPaginatedAsync(int page, int pageSize, int? userId, Category? category, string? search, PostType? postType, PostSource? sourceType, int? authorId, CancellationToken ct);
