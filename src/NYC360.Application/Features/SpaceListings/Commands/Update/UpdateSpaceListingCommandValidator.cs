...
public class UpdateSpaceListingCommandValidator : AbstractValidator<UpdateSpaceListingCommand>
{
    public UpdateSpaceListingCommandValidator()
    {
        RuleFor(x => x.Name)
            .NotEmpty()
            .MaximumLength(150);
    ...
    private static bool HasContactMethod(UpdateSpaceListingCommand request)
